...
time mpiexec -n 448 python -W ignore $SCRATCH/Bridges/benchmarks/in_memory_1/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/16node_$2

...
time mpiexec -n 448 python -W ignore $SCRATCH/Bridges/benchmarks/2-full_IO/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/16node_$2

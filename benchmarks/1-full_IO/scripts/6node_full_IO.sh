...
do
    ...
    do
        mpiexec -n $i python $SCRATCH/parallel_h5md/scripts/Bridges/rmsd/90Kframe/full_IO/full_IO_bench.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/6node_$j
    done
done

...
mkdir -p /pylon5/mc4sb2p/edisj/Bridges/benchmarks/in_memory_2/results/$1/slurm_output
cd /pylon5/mc4sb2p/edisj/Bridges/benchmarks/in_memory_2/results/$1/slurm_output

for repeat in 1 2 3
do
    sbatch /pylon5/mc4sb2p/edisj/Bridges/benchmarks/in_memory_2/scripts/copy_file.sh /pylon5/mc4sb2p/edisj/Bridges/benchmarks/in_memory_2/scripts/1node1.sh $1 $repeat

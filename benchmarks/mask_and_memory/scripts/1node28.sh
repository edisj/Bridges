...
time mpiexec -n 28 python -W ignore $SCRATCH/Bridges/benchmarks/mask_and_memory/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/1node_$2
